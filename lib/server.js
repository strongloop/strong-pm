...
function Server(cmd, baseDir, listenPort, controlPath, traceOptions) {
  ...
  this._serviceManager = new ServiceManager(this, !!traceOptions.enableTracing);

  var options = {};
  if (!!traceOptions.enableTracing) {
    options['trace.enable'] = true;
    options['trace.db.path'] = this._baseDir;
    options['trace.enableDebugServer'] = !!traceOptions.enableDebugServer;
  }
