...
Server.prototype._loadModels = function _loadModels(callback) {
  ...
  this.serviceId = parseInt(process.env.STRONGLOOP_SERVICE_ID, 10) || 1;
  var groupId = parseInt(process.env.STRONGLOOP_SERVICE_GROUP_ID, 10) || 1;
  this.executorId = parseInt(process.env.STRONGLOOP_EXECUTOR_ID, 10) || 1;
  this.containerId = parseInt(process.env.STRONGLOOP_CONTAINER_ID, 10) || 1;
  this.instanceId = parseInt(process.env.STRONGLOOP_INSTANCE_ID, 10) || 1;
