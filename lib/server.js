...
Server.prototype._onContainerStarted = function(container, supervisorInfo, cb) {
  var self = this;
...
Server.prototype._onContainerRequest = function(container, req, callback) {
  ...
  if (req.cmd === 'started') {
    ...
    return this._onContainerStarted(container, req, callback);
  }
...
Server.prototype.start = function start(cb) {
  ...
  function loadModels(callback) {
    self._serviceManager.loadModels(self._meshApp.models, callback);
  }
...
Server.prototype.setServiceState = function(svcId, started, callback) {
  this._serviceManager.setServiceStarted(svcId, started, callback);
};
