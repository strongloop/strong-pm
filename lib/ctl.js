...
function onCtlRequest(options, req, callback) {
  ...
  // FIXME Will need to choose target container instance based on...  something.
  // krishna? is service Id known at this point? I guess it should always be in
  // the request now.
  var container = options.server.containerByXXXX(req);
