...
function start(options) {
  ...
  var requestListener = onRequest.bind(null, options);
  var server = pmctlChannel.create(requestListener).listen(options.control);
  ...
  processChannel.attach(requestListener);
  return server;
}
