...
Driver.prototype.start = function(callback) {
  ...
  try {
    var instanceIds = fs.readdirSync(svcBase);
  } catch (er) {
    /* eslint */
    return callback();
  }
...
Driver.prototype.deployInstance = function(instanceId, req, res) {
  this._containerById(instanceId).onDeployment(req, res);
};
...
Driver.prototype.updateEnv = function(instanceId, env) {
  this._containerById(instanceId).updateEnv(env);
};
